...
4. Following that initial upload the id value in your local copy of file itminfo.json (line 16) will not be null anymore. Instead it will be a long string of characters, something like "1234567890ABC123XYZ".
